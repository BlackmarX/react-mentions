...
var MentionsInput = /*#__PURE__*/function (_React$Component) {
  ...
  function MentionsInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSelect", function (event) {
      // get event from shadow root if exists
      // for shadow roots there will be custom event which will fire on input select and send the event from shadow root
      var ev = event.detail ? event.detail.event : event; // keep track of selection range / caret position
