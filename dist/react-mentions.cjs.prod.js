...
var makeTriggerRegex = function(trigger) {
  ...
  return _createClass(MentionsInput, [ {
    ...
    value: function() {
      ...
      document.addEventListener("paste", this.handlePaste), window.addEventListener("trigger-shadow-root-input-onSelect", this.handleSelect), 
    ...
    value: function() {
      ...
      document.removeEventListener("paste", this.handlePaste), window.addEventListener("trigger-shadow-root-input-onSelect", this.handleSelect);
    }
  }, {
    key: "render",
    value: function() {
